...
from cat_seg.modeling.losses import (DiceLoss, BoundaryLoss)

@META_ARCH_REGISTRY.register()
class BoundaryAwareCATSeg(nn.Module):
    @configurable
    def __init__(
        self,
        *,
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            bce_loss = F.binary_cross_entropy_with_logits(outputs, _targets)

            tumor_pred = outputs[...,1]

            tumor_target = _targets[...,1]

            tumor_pred = tumor_pred.unsqueeze(1)
