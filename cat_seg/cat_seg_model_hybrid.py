...
from cat_seg.modeling.unetpp_branch import UNetPPBranch

@META_ARCH_REGISTRY.register()
class HybridCATSeg(nn.Module):
    @configurable
    def __init__(
        self,
        *,
        ...
        self.unetpp_branch = UNetPPBranch()
        try:

            self.unetpp_branch.load_pretrained(
                "checkpoints/unetplusplus_best.pth"
            )

            for param in self.unetpp_branch.parameters():
