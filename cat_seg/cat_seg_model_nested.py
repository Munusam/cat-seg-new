...
from cat_seg.modeling.nested_fusion import NestedFusion

from einops import rearrange

@META_ARCH_REGISTRY.register()
class NestedCATSeg(nn.Module):
    @configurable
    def __init__(
        self,
        *,
        ...
        self.nested_fusion = NestedFusion()
    ...
    def forward(self, batched_inputs):
        ...
        res3_nested = self.nested_fusion(
            res3,
            res4,
            res5
        )
        ...
        features = {'res5': res5, 'res4': res4, 'res3': res3_nested,}
